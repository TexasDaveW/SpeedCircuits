...
var tiles = [
  ...
  { instanceId: "led-1", catalogId: "led-red", gridX: 5, gridY: 5, rotation: 90 },
  { instanceId: "ground-1", catalogId: "ground-tile", gridX: 5, gridY: 6, rotation: 0 }
];
var outDir = join(process.cwd(), "circuit jsons");
mkdirSync(outDir, { recursive: true });
var doc = exportCircuit(tiles, "Reverse LED Polarity Test");
writeFileSync(join(outDir, "02-reverse-led-polarity-test.json"), `${JSON.stringify(doc, null, 2)}
`);
