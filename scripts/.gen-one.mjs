...
// scripts/write-lesson1.ts
var tiles = [
  { instanceId: "power-1", catalogId: "power-tile", gridX: 2, gridY: 5, rotation: 0 },
  { instanceId: "straight-1", catalogId: "straight-cube", gridX: 3, gridY: 5, rotation: 0 },
  { instanceId: "resistor-1", catalogId: "resistor-470", gridX: 4, gridY: 5, rotation: 0 },
  { instanceId: "led-1", catalogId: "led-red", gridX: 5, gridY: 5, rotation: 0 },
  { instanceId: "straight-2", catalogId: "straight-cube", gridX: 6, gridY: 5, rotation: 0 },
  { instanceId: "ground-1", catalogId: "ground-tile", gridX: 7, gridY: 5, rotation: 0 }
];
var outDir = join(process.cwd(), "circuit jsons");
mkdirSync(outDir, { recursive: true });
var doc = exportCircuit(tiles, "LED + Resistor");
var path = join(outDir, "01-led-plus-resistor.json");
