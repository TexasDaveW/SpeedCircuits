// scripts/generate-first-circuits.ts
...
function buildConnections(tiles) {
...
function exportCircuit(tiles, name) {
...
var CIRCUITS = [
  ...
  },
  {
    ...
    build: () => [
      ...
      { instanceId: nextId("straight-cube"), catalogId: "straight-cube", gridX: 5, gridY: 5, rotation: 90 },
      { instanceId: nextId("cross-cube"), catalogId: "cross-cube", gridX: 5, gridY: 6, rotation: 0 },
      { instanceId: nextId("ground-tile"), catalogId: "ground-tile", gridX: 5, gridY: 7, rotation: 0 },
      { instanceId: nextId("resistor-470"), catalogId: "resistor-470", gridX: 4, gridY: 4, rotation: 90 },
      { instanceId: nextId("led-red"), catalogId: "led-red", gridX: 4, gridY: 5, rotation: 270 },
      { instanceId: nextId("straight-cube"), catalogId: "straight-cube", gridX: 4, gridY: 6, rotation: 0 },
      { instanceId: nextId("resistor-470"), catalogId: "resistor-470", gridX: 6, gridY: 4, rotation: 90 },
      { instanceId: nextId("led-green"), catalogId: "led-green", gridX: 6, gridY: 5, rotation: 270 },
  ...
  },
  {
    ...
    build: () => [
      ...
      { instanceId: nextId("cross-cube"), catalogId: "cross-cube", gridX: 5, gridY: 6, rotation: 0 },
      { instanceId: nextId("ground-tile"), catalogId: "ground-tile", gridX: 5, gridY: 7, rotation: 0 },
      { instanceId: nextId("resistor-150"), catalogId: "resistor-150", gridX: 4, gridY: 4, rotation: 90 },
      { instanceId: nextId("led-red"), catalogId: "led-red", gridX: 4, gridY: 5, rotation: 270 },
      { instanceId: nextId("straight-cube"), catalogId: "straight-cube", gridX: 4, gridY: 6, rotation: 0 },
      { instanceId: nextId("resistor-4k7"), catalogId: "resistor-4k7", gridX: 6, gridY: 4, rotation: 90 },
      { instanceId: nextId("led-green"), catalogId: "led-green", gridX: 6, gridY: 5, rotation: 270 },
      { instanceId: nextId("straight-cube"), catalogId: "straight-cube", gridX: 6, gridY: 6, rotation: 0 }
    ]
  },
